...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        for (int i = 0; i < 20; i++)
        {
            listMain.add(i, Integer.parseInt(reader.readLine()));
        }
        ...
        for (int i = 0; i < listMain.size(); i++)
        {
                ...
                if (listMain.get(i) % 2 == 0) {
                    listDiv2.add(listMain.get(i));
                }
                if (listMain.get(i) % 3 == 0) {
                    listDiv3.add(listMain.get(i));
                }
...
//        for (int i = 0; i < listDiv2.size(); i++)
//        System.out.println(listDiv2.get(i));
//        for (int i = 0; i < listDiv3.size(); i++)
//        System.out.println(listDiv3.get(i));
//        for (int i = 0; i < listOther.size(); i++)
//        System.out.println(listOther.get(i));
        printList(listDiv3);
        printList(listDiv2);
        printList(listOther);
    }
